"""
Code is taken from the official PyTorch FLAME repo:
...
def rot_mat_to_euler(rot_mats: Tensor) -> Tensor:
    ...
    Careful for extreme cases of Euler angles like [0.0, pi, 0.0].
    """
    sy = torch.sqrt(
...
def lbs(
    ...
    pose2rot: bool = True,
    dtype: torch.dtype = torch.float32,
    detach_pose_correctives: bool = True,
) -> Tuple[Tensor, Tensor]:
...
def transform_mat(R: Tensor, t: Tensor) -> Tensor:
    ...
    t : torch.Tensor Bx3x1
        Batch of translation vectors

    Returns
    -------
    T: torch.Tensor Bx4x4
